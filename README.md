...
The first section consists of an brief explanation of the morphological and behavioral differences between healthy cells and cancer cells (slides are included in the repository).

In the second, hands-on section, the students set the features of the cancer cells to understand how each hallmark of cancer affects tumor behavior. They can also choose to administer chemotherapy, which slows down tumor growth by killing the cells, but can also worsen the patient's health due to toxicity.

The purpose of the activity is to explain the fundamentals of tumor growth to a young audience in a simple and accessible way, while illustrating the delicate balance between stopping tumor growth and preserving the health of oncological patients. It also seeks to raise awareness among children and adolescents about the challenges that cancer presents to scientists, physicians, and family members of oncological patients.
